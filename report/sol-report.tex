...
The SOL compiler was developed through a test-driven development approach. 
  ...
  \section{Manual Testing}
    Testing shape display and animation correctness was not possible within \textit{Travis CI} environment as it does not support a display console for testing. These test cases were written separately, in test files following naming pattern \texttt{mnl-*}, compiled and run using the same test script, although these required manual intervention for correctness of displayed graphics. Please see Appendix \ref{mnl-test} for manual test cases.
